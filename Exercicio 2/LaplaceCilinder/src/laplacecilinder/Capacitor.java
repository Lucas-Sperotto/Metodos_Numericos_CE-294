...
public class Capacitor {
     ...
     * @param V2
     */
    public void LePotenciais(double T1, double T2, double T3) {
        this.T1 = T1;
        this.T2 = T2;
        this.T3 = T3;
       // this.T4 = T4;
     ...
     */
    public void LeGeometria(double X0, double Y0, double Xf, double Yf, double Xc, double Yc) {
        this.X0 = X0;
        this.Y0 = Y0;
        this.Xf = Xf;
        this.Yf = Yf;
    ...
    public double CalculaResiduo(int i, int k) {
        ...
        double hy = Grid.den * Grid.den;//(-2.0 * U.getElement(i, k) * gx) + (-2.0 * U.getElement(i, k) * gy) +
        ...
        do {
            ...
            for (i = 1; i < Grid.Nx - 1; i++) {
                for (k = 1; k < Grid.Ny - 1; k++) {
                    ...
                    U.setElement(i, k, U.getElement(i, k) + w * res);//U.getElement(i, k) + 0.25 * w *
     ...
     */
    private void EscreveU(String str) {
