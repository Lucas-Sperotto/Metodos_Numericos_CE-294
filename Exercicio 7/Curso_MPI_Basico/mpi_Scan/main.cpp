...
/*********************************************************************
    ...
    Programa para teste da subrotina MPI_Scan
    ...
    para compilar
    mpic++ -o  mpiscan.bin main.cpp

    para executar
    mpirun -np 2 mpiscan.bin
...
//    }
    ...
    std::cout << " Antes da chamada de MPI_Scan " << std::endl;
...
//          recv_msg[i] = i;
    ...
    MPI_Scan(&send_msg,&recv_msg,1, MPI_INT, MPI_SUM,MPI_COMM_WORLD);
